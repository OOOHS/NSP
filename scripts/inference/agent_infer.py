...
parser.add_argument('--actor', default='./model_checkpoints/RL/actor.pkl', type=str, help='Actor model')
parser.add_argument('--renderer', default='./model_checkpoints/RL/renderer.pkl', type=str, help='renderer model')
...
if __name__ == "__main__":
    ...
    #         # 保存每一步的动作到字典中
    #         action_dict[i] = actions.detach().cpu().numpy().tolist()  # 将 NumPy 数组转换为列表并存入字典
